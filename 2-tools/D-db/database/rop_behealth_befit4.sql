...
--
-- Hostiteľ: 127.0.0.1
-- Čas generovania: Pi 10.Mar 2023, 09:24
...
(1, 'stanislav.medvec@gmail.com', '$2y$10$28hhTUUjxQRiTkeZXqK/dON8kIjPkmFu/TensEZJSOMDGZRXSlZDC', 'Stanislav', 'Medvec', 1, 19, 170, 60, 1),
(3, 'renata@gmail.com', '$2y$10$KrLfKikoh3NWsQXlqWEQ.uI8BjjwKj8litedmgTq0XU10SgqtECDi', 'Renata', 'Medvecova', 2, 48, 165, 58, 1),
(4, 'stanislav@gmail.com', '$2y$10$5SRGiQ.lGIEsKicIVQNE9eiYL5TwfhEpHSTo9yvZiDllCJBGOfVfW', 'Stanislav', 'Medvec', 1, 52, 172, 75, 1);
...
--
ALTER TABLE `useractivity`
  MODIFY `idUsrAct` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
